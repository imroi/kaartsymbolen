    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>101</se:Name>
          <se:Description>
            <se:Title>Aandachtspunt bij brand</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>102</se:Name>
          <se:Description>
            <se:Title>Stoplijn in heide/gras vegetatie</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>maatregel_type_id</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>103</se:Name>
          <se:Description>
            <se:Title>Stoplijn door voorbranden</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>maatregel_type_id</ogc:PropertyName>
          ...
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#0022a8</se:SvgParameter>
              <se:SvgParameter name="stroke-width">3</se:SvgParameter>
              <se:SvgParameter name="stroke-linejoin">bevel</se:SvgParameter>
              <se:SvgParameter name="stroke-linecap">square</se:SvgParameter>
              <se:SvgParameter name="stroke-dasharray">1 2</se:SvgParameter>
